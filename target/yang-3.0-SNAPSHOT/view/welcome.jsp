...
<%--<canvas class='background' height='2000px' width='2000px'> </canvas>--%>
	<div style="position: absolute;left: 1%;top: 0;font-size: 20px">
		...
		<p>输入关键字进行搜索<form action="sercharticles" method="get">
		...
		<input type="submit" value="搜索">
			...
			<%--<input type="submit" value="搜索">--%>
			<%--</form>--%>
			<p>输入用户ID查看TA的资料<form action="serchuser" method="get">
			<input type="text" name="id">
			<input type="submit" value="搜索">
		</form>
	</div>
	...
	<center>
		<p>近期文章<br><br>
			...
			<font color="red">作者的昵称:<a href="serchuser?id=<%=article.getApk().getId()%>"></font><%out.println(article.name+"  ");%></a>
