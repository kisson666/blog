...
<body>
	<form action="addarticle" method="post">
		...
		<input type="radio" name="privatesee" value="1">仅自己可见&nbsp;<input type="radio" name="privatesee" value="0" checked>所有人可见<br><input type="submit" value="提交文章" style="font-size:25px">
	</form>
	 <!-- 配置文件 -->
